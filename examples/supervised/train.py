...
from libs.training.pipelines.supervised import SupervisedPipeline
...
if __name__ == "__main__":
    ...
    config: SupervisedConfig = load_configuration(args.config)
    ...
    pipeline.install_callback(pipeline.log_interval, image_logger, only_main_process=True)
